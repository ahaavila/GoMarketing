...
const Cart: React.FC = () => {
  ...
  // Função que vai executar o hook de increment
  function handleIncrement(id: string): void {
    increment(id);
  }

  // Função que vai executar o hook de decrement
  function handleDecrement(id: string): void {
    decrement(id);
  }

  // Função que vai chamar o hook que calcula o valor total do carrinho
  ...
  // Função que vai chamar o hook que calcula a quantidade de itens do carrinho
